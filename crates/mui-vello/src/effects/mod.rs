...
pub mod damage;
mod tiled;
pub use tiled::{TiledEffects,TileStats};
#[cfg(test)] mod tests;
...
impl From<mui_weld::Error> for Error {fn from(e:mui_weld::Error)->Self{Self::Parameters(e)}}
impl From<mui_geometry::Error> for Error {fn from(e:mui_geometry::Error)->Self{Self::Geometry(e)}}
