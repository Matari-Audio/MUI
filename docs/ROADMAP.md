...
| Content | Host measurement callback, optional Parley shaping/wrapping with final glyph layouts, single-line playground text | **P0:** documented host font/image measurement contract and reference adapter. **P1:** baseline integration, rich spans, images and SVG content; connect Parley output to the renderer and playground |
