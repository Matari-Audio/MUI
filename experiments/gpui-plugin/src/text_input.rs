// Adapted from Zed GPUI examples/input.rs at 7960b2a7c9568e90fbe0727332149e5b2a5fd57a.
...
impl Render for TextInput {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        div()
            ...
            .bg(crate::live_theme::color(0x252c28))
            .text_color(crate::live_theme::color(0xe0e5da))
            .line_height(px(30.))
            .text_size(px(16.))
            .child(
                div()
...
impl TextInput {
    ...
    pub fn with_value(cx: &mut Context<Self>, value: &str, label: &str) -> Self {
        let mut input = Self::new(cx);
        input.content = value.to_owned().into();
        input.placeholder = label.to_owned().into();
        input
    }
